        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20">
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-2xl font-bold text-white">Revenia</span>
            </div>
            <h1 className="text-display-md text-white mb-4">
              Motor de reservas directas para hoteles
            </h1>
            <p className="text-lg text-white/70 leading-relaxed">
              La plataforma multi-tenant para hoteles pequeños y medianos. Centraliza disponibilidad, cobra online y elimina comisiones de OTAs.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 text-white/80">
              ...
              <span>Booking engine propio, sin comisiones de OTAs</span>
            </div>
            <div className="flex items-center gap-3 text-white/80">
              <div className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span>Gestión de habitaciones, tarifas y disponibilidad</span>
            </div>
            <div className="flex items-center gap-3 text-white/80">
              <div className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
