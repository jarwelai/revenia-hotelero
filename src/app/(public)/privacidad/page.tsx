          ...
          <div className="space-y-8 text-foreground-secondary text-body-md leading-relaxed">
            <div>
              ...
              <ul className="list-disc pl-6 mt-3 space-y-2">
                ...
                <li>Información relacionada con sus reservas y preferencias de alojamiento</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 mt-3 space-y-2">
                ...
                <li>Gestionar sus reservas de hotel</li>
                <li>Proporcionarle servicios de reservas y alojamiento</li>
            ...
            <div>
              ...
              <p>
                En Revenia, nos comprometemos a proteger la confidencialidad de su información personal y datos de pago. Su información no será divulgada a terceros sin su consentimiento expreso, salvo cuando la ley lo requiera o sea necesario para completar su reserva.
              </p>
            </div>
